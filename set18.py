        ...
        if fopen == 'quit': 
            ...
            for row in df:
                ...
                if ci not in documents:
                    ...
                    conceptos[ci] =  conceptos[ci] + '/' + concepto
                    for i in range(len(list2)):
                        if list2[i]['CEDULA'] == ci:
                            list2[i]['count-cedula'] = documents[ci]
                            list2[i]['SUMA-SALARIO'] = salaries[ci]
                            list2[i]['CONCEPTO'] = conceptos[ci]
                        else:
                            continue
